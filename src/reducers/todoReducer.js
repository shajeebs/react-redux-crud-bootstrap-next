...
//   ...currentState, pocos:currentState.pocos, poco:null, isFetching: false, error: null,
...
export  const todoReducer = (currentState = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case todoActions.FETCH_TODO_SUCCESS:
          return {
            ...currentState, pocos:currentState.pocos, poco:action.poco, isFetching: false, error: null,
            successMsg:action.message, showDeleteModal: false, todoToDelete: null, showEditModal: false,
            todoToEdit: null,showViewModal: false, pocoToView: null,
          }
    ...
    case todoActions.ADD_TODO_REQUEST_FAILED:
          return {
            ...currentState, pocos:currentState.pocos, poco:null, isFetching: false, error: action.error,
            successMsg:null, showDeleteModal: false, todoToDelete: null, showEditModal: false,
            todoToEdit: null,showViewModal: false, pocoToView: null, newTodo: null
          }
  ...
  case todoActions.DELETE_TODO_SUCCESS:
        const filteredPocos = currentState.pocos.filter((pocoData) => pocoData._id !== action.poco._id)
        return {
            ...currentState, pocos:filteredPocos, poco:null, isFetching: false, error: null,
            successMsg:action.message, showDeleteModal: false, todoToDelete: action.poco, showEditModal:false,
            todoToEdit:null , showViewModal: false, pocoToView: null, newTodo: null,
          }
